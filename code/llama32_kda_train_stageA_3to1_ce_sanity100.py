...
class TrainConfig:
    ...
    output_dir: str = "/root/kda_project/Kimi_Project/llama32_kda_samecorpus_s1_4k_3to1_ce_sanity100"
    final_dir_name: str = "final_stage2_full_kda"
    cache_dir: str = "/root/kda_project/huggingface_cache"
    multi_user_safe: bool = False
    run_name: str = "llama32_kda_3to1_ce_sanity100"
    ...
    pin_checkpoint_steps: Tuple[int, ...] = (20, 50, 100)
